...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                USE_BANNER, USE_LISTVIEW, METADATA_XBMC, METADATA_MEDIABROWSER, METADATA_PS3, METADATA_SYNOLOGY, METADATA_ATV, metadata_provider_dict, \
        ...
        # this is the normal codepath for metadata config
            ...
            METADATA_ATV = check_setting_str(CFG, 'General', 'metadata_atv', '0|0|0|0|0|0')
...
def save_config():
    ...
    new_config['General']['metadata_atv'] = metadata_provider_dict['Apple TV'].get_config()
