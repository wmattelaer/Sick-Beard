...
class ConfigPostProcessing:
    ...
    def savePostProcessing(self, naming_pattern=None, naming_multi_ep=None,
                    xbmc_data=None, xbmc_12plus_data=None, mediabrowser_data=None, sony_ps3_data=None, wdtv_data=None, tivo_data=None, mede8er_data=None,apple_tv_data=None,
        ...
        sickbeard.METADATA_ATV = apple_tv_data
        ...
        sickbeard.metadata_provider_dict['Apple TV'].set_config(sickbeard.METADATA_ATV)
